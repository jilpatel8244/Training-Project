...
CREATE TABLE `reference_contact` (
  ...
  `ref_contact` varchar(13) DEFAULT NULL,
  `ref_relation` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `candidate_id` (`candidate_id`),
  CONSTRAINT `reference_contact_ibfk_1` FOREIGN KEY (`candidate_id`) REFERENCES `basic_details` (`id`)
...
INSERT INTO `reference_contact` VALUES (1,210,'divya','9874563214','sister'),(3,212,'','',''),(4,214,'','',''),(5,215,'','',''),(6,216,'','',''),(7,218,'','','');
