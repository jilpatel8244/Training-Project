    ...
    xhr.onload = async function () {
        if (this.status == 200) {
            ...
            if (obtainedData.basic_details) {
                ...
                console.log('error : wrong input number');
                document.getElementsByTagName('body')[0].innerHTML = `<p>wrong input number ${searchParams.get('id')}</p>`;
            }
        }
    }
